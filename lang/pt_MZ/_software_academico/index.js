export default {
    ...
    eSchooling_management_system: {
      title: 'Sistema de Gestão Académica eSchooling',
      text: 'O eSchooling é um software de gestão académica que permite gerir todos os aspetos da sua instituição universitária ou escolar, facilitando o registo de sumários, faltas, horários, notas, matrículas, planos curriculares, certificados e permitindo visualizar toda a gestão financeira, propinas, pagamentos por entidade-referência, sem esquecer a obtenção de vários relatórios. Tudo isto, auxiliado através da App mobile, garantindo aos professores e estudantes a rapidez e simplicidade no acesso a todos os seus dados pedagógicos e financeiros.',
